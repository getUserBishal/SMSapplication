...
<div style="background-color: rgb(228, 228, 228); padding: 20px; max-width: 600px; margin: 0 auto;">
    ...
    <script>
        ...
        function single_updateInfo(text) {
            ...
            totalsingle_rate = single_smsCount * single_rate;
            ...
            if (single_nepaliMode) {
                single_fetchNepaliSuggestions(text)
                    .then(nepaliSuggestions => {
...
if (selectedNumber) {
    single_selectNumber(selectedNumber);
} else {
    document.getElementById('single_selectedNumbersInput').value = '';
}
}
